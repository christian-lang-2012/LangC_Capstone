...
public class AL_Parser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "ALGrammar.g4"; }
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public TerminalNode ProgramHeader() { return getToken(AL_Parser.ProgramHeader, 0); }
		...
		public TerminalNode MethodHeader() { return getToken(AL_Parser.MethodHeader, 0); }
		public TerminalNode VariableHeader() { return getToken(AL_Parser.VariableHeader, 0); }
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			if (_la==ProgramHeader) {
				{
				setState(60); match(ProgramHeader);
				}
			}

			setState(63); programDeclaration();
			setState(65);
			_la = _input.LA(1);
			if (_la==VariableHeader) {
				{
				setState(64); match(VariableHeader);
				}
			}
			...
			if (_la==MethodHeader) {
				{
				setState(73); match(MethodHeader);
				}
			}
	...
	public static class ProgramDeclarationContext extends ParserRuleContext {
		...
		public List<TerminalNode> QUOTE() { return getTokens(AL_Parser.QUOTE); }
		public TerminalNode Identifier() { return getToken(AL_Parser.Identifier, 0); }
		public TerminalNode PROGRAM() { return getToken(AL_Parser.PROGRAM, 0); }
		public TerminalNode THIS() { return getToken(AL_Parser.THIS, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterProgramDeclaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitProgramDeclaration(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarVisitor ) return ((GrammarVisitor<? extends T>)visitor).visitProgramDeclaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MethodDeclarationContext extends ParserRuleContext {
		...
		public TerminalNode FUNCTION() { return getToken(AL_Parser.FUNCTION, 0); }
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(106); formalParameters();
			setState(109);
			switch (_input.LA(1)) {
			case BEGIN:
				{
				setState(107); methodBody();
				}
				break;
			case SEMI:
				{
	...
	public static class BlockContext extends ParserRuleContext {
		...
		public TerminalNode BEGIN() { return getToken(AL_Parser.BEGIN, 0); }
		public TerminalNode END() { return getToken(AL_Parser.END, 0); }
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public TerminalNode VariableIdentifier() { return getToken(AL_Parser.VariableIdentifier, 0); }
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case SWITCH:
				...
				while ( _alt!=2 && _alt!=-1 ) {
					if ( _alt==1 ) {
						{
						{
						setState(156); switchBlockStatementGroup();
						}
						} 
					}
					setState(161);
			...
			case CONTINUE:
				...
				if (_la==VariableIdentifier) {
					{
					setState(181); match(VariableIdentifier);
					}
				}
			...
			case Identifier:
				...
				{
				setState(186); statementExpression();
			...
			case VariableIdentifier:
				...
				{
				setState(189); match(VariableIdentifier);
				setState(190); match(COLON);
	...
	public final SwitchLabelContext switchLabel() throws RecognitionException {
		...
		try {
			...
			case CASE:
				...
				setState(205); constantExpression();
	...
	public final ForControlContext forControl() throws RecognitionException {
		...
		try {
			...
			case 13:
				enterOuterAlt(_localctx, 1);
				{
				setState(212); enhancedForControl();
				}
				break;
			case LET:
			case IntegerLiteral:
	...
	public final EnhancedForControlContext enhancedForControl() throws RecognitionException {
		...
		try {
			...
			{
			setState(230); type();
			setState(231); match(VariableIdentifier);
	...
	public static class ConstantExpressionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarVisitor ) return ((GrammarVisitor<? extends T>)visitor).visitConstantExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final FormalParametersContext formalParameters() throws RecognitionException {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 1) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 9) | (1L << 13))) != 0)) {
				{
				setState(254); formalParameterList();
				}
			}
	...
	public final FormalParameterContext formalParameter() throws RecognitionException {
		...
		try {
			...
			{
			setState(267); type();
			setState(268); match(VariableIdentifier);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VariableDeclaratorsContext variableDeclarators() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(270); variableDeclaration();
			setState(275);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(272); variableDeclaration();
				}
				}
				setState(277);
				_errHandler.sync(this);
	...
	public static class VariableDeclarationContext extends ParserRuleContext {
		...
		public TerminalNode LET() { return getToken(AL_Parser.LET, 0); }
	...
	public final VariableDeclarationContext variableDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(279); type();
			setState(280); variableDeclarationID();
			setState(283);
			_la = _input.LA(1);
			if (_la==ASSIGN) {
				{
				setState(281); match(ASSIGN);
				setState(282); variableInitialization();
				}
			}
	...
	public static class VariableDeclarationIDContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterVariableDeclarationID(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitVariableDeclarationID(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarVisitor ) return ((GrammarVisitor<? extends T>)visitor).visitVariableDeclarationID(this);
			else return visitor.visitChildren(this);
		}
	}

	public final VariableDeclarationIDContext variableDeclarationID() throws RecognitionException {
		VariableDeclarationIDContext _localctx = new VariableDeclarationIDContext(_ctx, getState());
		enterRule(_localctx, 46, RULE_variableDeclarationID);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(287); match(VariableIdentifier);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class VariableInitializationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).enterVariableInitialization(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GrammarListener ) ((GrammarListener)listener).exitVariableInitialization(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GrammarVisitor ) return ((GrammarVisitor<? extends T>)visitor).visitVariableInitialization(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				consume();
				setState(300); expression(13);
				}
				break;

			case 4:
				{
				setState(301); primary();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 6:
						...
						setState(328); match(BITAND);
						setState(329); expression(8);
						}
						break;
					...
					case 11:
						...
						case ADD_ASSIGN:
							{
							setState(344); match(ADD_ASSIGN);
							}
							break;
						case SUB_ASSIGN:
							{
							setState(345); match(SUB_ASSIGN);
							}
							break;
						case MUL_ASSIGN:
							{
							setState(346); match(MUL_ASSIGN);
							}
							break;
						case DIV_ASSIGN:
							{
							setState(347); match(DIV_ASSIGN);
							}
							break;
						case AND_ASSIGN:
							{
							setState(348); match(AND_ASSIGN);
							}
							break;
						case OR_ASSIGN:
							{
							setState(349); match(OR_ASSIGN);
							}
							break;
						case XOR_ASSIGN:
							{
							setState(350); match(XOR_ASSIGN);
							}
							break;
						case RSHIFT_ASSIGN:
							{
							setState(351); match(RSHIFT_ASSIGN);
							}
							break;
						case URSHIFT_ASSIGN:
							{
							setState(352); match(URSHIFT_ASSIGN);
							}
							break;
						case LSHIFT_ASSIGN:
							{
							setState(353); match(LSHIFT_ASSIGN);
							}
							break;
						case MOD_ASSIGN:
							{
							setState(354); match(MOD_ASSIGN);
							}
							break;
						default:
							throw new NoViableAltException(this);
						}
						setState(357); expression(1);
						}
						break;
					...
					case 12:
						...
						setState(359); match(QUESTION);
						setState(360); expression(0);
						setState(361); match(COLON);
						setState(362); expression(3);
						}
						break;
					...
					case 14:
						...
						setState(368); match(LBRACK);
						setState(369); expression(0);
						setState(370); match(RBRACK);
						}
						break;
	...
	public static class LiteralContext extends ParserRuleContext {
		public TerminalNode NullLiteral() { return getToken(AL_Parser.NullLiteral, 0); }
		public TerminalNode CharacterLiteral() { return getToken(AL_Parser.CharacterLiteral, 0); }
		public TerminalNode IntegerLiteral() { return getToken(AL_Parser.IntegerLiteral, 0); }
		public TerminalNode StringLiteral() { return getToken(AL_Parser.StringLiteral, 0); }
		public TerminalNode FloatingPointLiteral() { return getToken(AL_Parser.FloatingPointLiteral, 0); }
		public TerminalNode BooleanLiteral() { return getToken(AL_Parser.BooleanLiteral, 0); }
